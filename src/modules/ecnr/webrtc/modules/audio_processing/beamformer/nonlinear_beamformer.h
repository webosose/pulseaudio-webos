...
#include "../../../modules/audio_processing/beamformer/doa.h"
...
class NonlinearBeamformer
 ...
 public:
  ...
  void SetAutoAim(bool enable) override { auto_aim_enable_ = enable; }

  float GetDirection() override { return target_angle_radians_; }
...
// #endif
  ...
  //  LGE: Auto aim steering
  void AutoAim(const complex_f* const* input,
                int num_input_channels,
                size_t num_freq_bins);
  ...
  //  Number of processed blocks for update auto aim
