...
PA_MODULE_DESCRIPTION("Echo Cancellation with Noise Reduction");
...
int pa__init(pa_module*m) {
    ...
    source_data.name = pa_sprintf_malloc("ecnr_source");
    ...
    pa_proplist_sets(source_output_data.proplist, PA_PROP_MEDIA_NAME, "ECNR Stream");
    ...
    pa_proplist_sets(sink_input_data.proplist, PA_PROP_MEDIA_NAME, "ECNR Stream");
